package com.example.ufanet.passwordView;
...
import static com.example.ufanet.passwordView.PasscodeView.PasscodeViewType.TYPE_CHECK_PASSCODE;
...
public class PasscodeView extends FrameLayout implements View.OnClickListener {
    ...
    private int numberTextColor = 0xFF313435;
    ...
    public PasscodeView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        firstInputTip = firstInputTip == null ? "Введите 4-х значный код" : firstInputTip;
        secondInputTip = secondInputTip == null ? "Повторите пароль" : secondInputTip;
        wrongLengthTip = wrongLengthTip == null ? firstInputTip : wrongLengthTip;
        wrongInputTip = wrongInputTip == null ? "Введен неверный пароль" : wrongInputTip;
        correctInputTip = correctInputTip == null ? "Пароли введен верно" : correctInputTip;
    ...
    @IntDef({PasscodeViewType.TYPE_SET_PASSCODE, TYPE_CHECK_PASSCODE})
